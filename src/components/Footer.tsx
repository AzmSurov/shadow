...
const Footer = () => {
  ...
  <Avvvatars value="best_user@gmail.com" style="shape" size={35} />
    ...
    <p className="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2020 —
      <a href="https://www.azms.me" className="text-gray-600 ml-1" rel="noopener noreferrer" target="_blank">Azm Mohibul Haque Surov</a>
    </p>
    <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
      <a  href="https://www.azms.me" className="text-gray-500">
